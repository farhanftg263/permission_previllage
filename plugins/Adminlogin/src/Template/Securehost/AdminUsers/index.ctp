    ...
    <div class="col-sm-6" style="width: 20%;">
        <div id="example1_length" class="dataTables_length" style="float:left !important;">
            ...
            echo $this->Html->link('+ Add',
                ['controller' => 'AdminUsers', 'action' => 'add'],
                ['title' => 'Add Admin User','class'=>'btn btn-primary']
            );
            ?>                      
        </div>
    </div>
    ...
    <table id="example1" class="table table-bordered table-striped">
        ...
        <thead>
            <tr>
                ...
                <th><?= $this->Paginator->sort('role_id', 'Role Name');?></th>
            ...
            <tr id="detele_<?= $user->id;?>">
                ...
                <td>
                    ...
                    if($user->role_id != ADMIN)
                    {
                        ...
                        { 
                            echo $this->Html->link('<i class="fa fa-fw fa-check"></i>',
                                "javascript:void(0)",
                                //['controller' => 'Users', 'action' => 'status', $user->id,0],
                                [
                                    'class'=>'status',
                                    'value' => $user->id,
                                    'status' => 0,
                                ...
                                echo $this->Html->link('<i class="fa fa-fw fa-close"></i>',
                                    "javascript:void(0)",
                                    //['controller' => 'Users', 'action' => 'status', $user->id,1],
                                    [
                                        'class'=>'status',
                                        'value' => $user->id,
                                        'status' => 1,
                    ...
                    echo $this->Html->link('<i class="fa fa-fw fa-edit"></i>',
                        ['controller' => 'AdminUsers', 'action' => 'edit', $user->id],
                        [
                            'status' => 1,
                            'title' => 'Edit',
                            'escape' => false
