...
<?php
$this->Breadcrumbs->addCrumb('EmailTemplate List', ['controller' => 'EmailTemplates', 'action' => 'index']);
...
<div class="row">
    <?php    
        ...
        echo $this->Form->create(
            $email_template, 
            [
                'url' => ['controller' => 'EmailTemplates', 'action' => 'add'],
                'type' => 'file',
    ...
    <div class="col-md-6">
        ...
        echo $this->Form->control(
            ...
            [
                'required' => false,
                'type' => 'text',
                'label' => 'Title<sup style="color: #ce340b;">*</sup>',
